...
export default function Rocket() {
  ...
  const rocketY = useTransform(
    scrollYProgress,
    [0, 0.03, 0.06, 0.1, 0.15, 1],
    [0, -250, -600, -950, -1600, -4500],
    { clamp: false }
  );

  const exhaustHeight = useTransform(scrollYProgress, [0, 0.02, 0.05, 0.15, 1], [0, 120, 240, 520, 800]);
  ...
  return (
    <>
      <div className="rocketContainer" aria-hidden="true">
        <motion.div
          style={{
            y: rocketY,
      ...
      <motion.div
        className="rocketFlameContainer"
        aria-hidden="true"
        style={{ y: rocketY }}
      >
        <motion.div
